...
export default async function CompetitorsPage() {
  ...
  return (
    <DashboardLayout activeHref="/dashboard/competitors" profileName={org?.name ?? 'Meu Negócio'} userEmail={user.email ?? ''}>
      <div className="px-6 py-8 max-w-5xl">
        <h1 className="text-2xl font-bold text-white mb-2">Concorrentes</h1>
