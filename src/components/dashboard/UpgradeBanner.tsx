    ...
    >
      <div>
        ...
        <ul className="mt-2 flex flex-col gap-1">
          {[
            'Posts semanais automáticos no Google Meu Negócio',
            'Respostas às avaliações geradas por IA',
            'Otimização do perfil sem precisar abrir o painel',
            'Monitoramento de concorrentes na sua região',
          ].map(item => (
        ...
        <p className="text-xs mt-2" style={{ color: 'rgba(255,255,255,0.5)' }}>
          R$197/mês. Garantia de 30 dias. Cancele quando quiser.
        </p>
      </div>
