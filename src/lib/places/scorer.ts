...
export function placeDetailsToProfileData(place: PlaceDetails): GmbProfileData {
  ...
  return {
    ...
    // Fotos: Places API retorna ate 10 referencias
    // Estimamos: 1 = capa, 1 = logo, resto = espaco
    ...
    reviewsRepliedCount: 0, // nao disponivel via Places API

    // Posts: nao disponivel via Places API, penaliza
    lastPostDaysAgo: null,

    // Servicos e atributos: nao disponiveis via Places API
    servicesCount: 0,
...
// Mock para quando a Places API nao esta configurada
